...
pub fn render(f: &mut Frame, theme: &Theme, scroll: usize) {
    ...
    let left = vec![
        ...
        key_line(theme, "  g / G",          "Jump first / last (all views)"),
        key_line(theme, "  Enter / l",      "Drill-down / confirm"),
        key_line(theme, "  PageUp/Dn",      "Scroll list"),
        key_line(theme, "  t",              "Cycle color theme (name flashes)"),
        key_line(theme, "  C",              "Config overlay  (↑↓ scroll)"),
        ...
        key_line(theme, "  a",     "Ack all alerts  (Enter = ack one)"),
        Line::from(""),
    ...
    let right = vec![
        ...
        Line::from(""),
        key_line(theme, "NFS View (F5)", ""),
        key_line(theme, "  ↑↓",  "Scroll mount table"),
        Line::from(""),
        ...
        key_line(theme, "  --report-html [--output F]", "Self-contained HTML report"),
        ...
        key_line(theme, "  --report-md [--output F]",  "Markdown health report"),
        ...
        key_line(theme, "  --smart-errors DEV",  "SMART ATA/NVMe error log"),
        key_line(theme, "  --du [PATH]",         "Top dirs by disk usage (du)"),
        key_line(theme, "  --label DEV[=LABEL]", "View/set filesystem label"),
        ...
        key_line(theme, "  --sector-errors [DEV]", "Pending/reallocated sector counts"),
        ...
        key_line(theme, "  --man",    "Print man page (pipe to: man -l -)"),
        key_line(theme, "  --install","Install binary + man page to /usr/local"),
        key_line(theme, "  --version-info", "Detailed version + tool availability"),
        key_line(theme, "  --bench-write DEV", "Sequential write benchmark (temp file)"),
        key_line(theme, "  --diag",            "Self-diagnostic: tools, config, cache"),
